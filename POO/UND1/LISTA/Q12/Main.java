...
public class Main {
	public static void main(String[] args) {
		...
		VerificacaoGenerica<String> stringsGenericas = new VerificacaoGenerica<>("izaias", "izaias", "isaias");
		// Demonstrações:
		...
		VerificacaoGenerica<Double> reaisGenericos = new VerificacaoGenerica<>(4.1D, 4.2D, 4D);
		// Demonstrações:
